...
def generate_alerts(log: DailyLog, thresholds: Dict[str, Dict[str, float]] = None) -> List[Dict[str, Any]]:
    """
    ...
    for metric in metrics:
        ...
        if value < min_limit or value > max_limit:
            ...
            alerts.append({
                ...
                "severity": "critical",
                "message": f"{readable_metric} is too {condition} ({value}). Safe range is {min_limit} to {max_limit}.",
            })
