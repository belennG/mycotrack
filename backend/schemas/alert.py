    ...
    model_config = ConfigDict(
        json_schema_extra={
            "example": {
                ...
                "statistics": {
                    "temperature": {"min": 20.5, "max": 24.0, "avg": 22.1, "trend": "increasing"},
                    "humidity": {"min": 80.0, "max": 88.0, "avg": 84.5, "trend": "stable"}
                }
            }
        }
    )
    ...
    model_config = ConfigDict(
        json_schema_extra={
            "example": {
                ...
                "alerts_count": 1,
                "key_metrics": {"temperature": 22.1, "humidity": 84.5, "ph_level": 6.5, "moisture": 85.0},
                "recent_alerts": [
                    {
